...
function Screen({scene}: {scene: LandscapeScene}) {
  return <><div style={{position: 'absolute', left: 76, top: 130, width: 505}}><div style={{fontSize: 60, lineHeight: 1.08, color: '#fff', fontWeight: 1000}}>{scene.title}</div>{scene.callout && <div style={{marginTop: 30, display: 'inline-block', background: '#73D7FF', color: '#07141F', borderRadius: 18, padding: '16px 24px', fontSize: 34, fontWeight: 1000}}>{scene.callout}</div>}</div><div style={{position: 'absolute', left: 625, top: 134, width: 1215, height: 684, borderRadius: 24, overflow: 'hidden', border: '6px solid rgba(255,255,255,0.9)', boxShadow: '0 24px 80px rgba(0,0,0,0.34)', background: '#071B2E'}}>{scene.screenMedia ? <Img src={staticFile(scene.screenMedia)} style={{width: '100%', height: '100%', objectFit: 'cover'}} /> : <div style={{color: '#DDF6FF', fontSize: 36, padding: 80}}>{scene.screenNote}</div>}</div></>;
}
